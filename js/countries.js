/**
 * Real country names + international dialing codes, used to populate the
 * Country dropdown and the phone country-code dropdown on the contact form.
 * Sorted alphabetically by name. Shared, static data, no external API.
 */
const COUNTRIES = [
